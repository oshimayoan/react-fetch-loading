...
var loadingInjector = function loadingInjector(fetchingPropKey, LoadingComponent) {
  return function (ComposedComponent) {
    function WrapperComponent(props) {
      var child = _react2.default.createElement(_reactLoadingIndicator2.default, { segments: 10, segmentWidth: 5, segmentLength: 10 });
      if (LoadingComponent) {
        child = _react2.default.createElement(LoadingComponent, null);
      }
